...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicHJvYXJiYXoxOTk5IiwiYSI6ImNsZjZyazYxYTE5MXMzdG8xaDNvOTB4bXIifQ.rtKx-V7QbTQYYBX_0t_ZHw';
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status = 'success') {
            location.reload(true); //true is for relaoding fresh page from server rather than browser from cache
          }
          _context2.next = 10;
          break;
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'Error in updating Data');
        case 10:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " has been changed Successfully"));
          }
          _context.next = 11;
          break;
        case 8:
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51MnP3pSGkM1isxLM5ZX6ROZ1tDmnk3oioZEyLHWi47ACULhbEIXo8I38aBun8H1N4ong9O8709xAYXrEZ1KLUyhF00k6XkE7Cv');
